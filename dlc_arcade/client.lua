...
EnableInteriorProp(ch_dlc_arcade, "entity_set_mural_neon_option_07") -- EYES
...
EnableInteriorProp(ch_dlc_arcade, "entity_set_mural_option_03") -- ANIME
...
EnableInteriorProp(ch_dlc_arcade, "entity_set_floor_option_03") -- ANIME
